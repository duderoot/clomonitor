...
{{ template "dt/create_component_mapping.sql" }}
{{ template "dt/update_component_mapping.sql" }}
{{ template "dt/delete_component_mapping.sql" }}
{{ template "dt/ignore_unmapped_component.sql" }}
